...
import EyeOpen from "../../../assets/icons/eye_open.svg?react";
import EyeClose from "../../../assets/icons/eye_close.svg?react";
  ...
  (props, ref) => {
    ...
    return (
      <Input ref={ref} {...rest} type={isVisible ? "text" : "password"}>
        {isVisible ? (
          <EyeOpen className={styles.icon} onClick={() => setIsVisible(false)} />
        ) : (
          <EyeClose
